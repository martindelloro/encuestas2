-- View: encuestas.v_enviar_mail_primera_vez

-- DROP VIEW encuestas.v_enviar_mail_primera_vez;

CREATE OR REPLACE VIEW encuestas.v_enviar_mail_primera_vez AS 
...
ALTER TABLE encuestas.v_enviar_mail_primera_vez
  OWNER TO encuestas;
