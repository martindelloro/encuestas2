<div class="well span8">
	...
	<div>
		<?php echo $this->Js->link("<i class='icon icon-search icon-white'> Buscar</i>",array('controller'=>'usuarios','action'=>'buscar'),array('update'=>'#resultado_busqueda','before'=>'inicia_ajax()','complete'=>'fin_ajax()','escape'=>false,"with"=>"$(this).parents('form:first').serialize()","class"=>"btn btn-inverse")); 
