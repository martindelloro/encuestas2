...
<ul class="nav nav-pills borde-abajo barra-nav" style="clear:both">
    <li class="active"><?php echo $this->Html->link("Datos Usuario","#DatosUsuario",array("data-toggle"=>"tab")) ?></li>
...
<div class="modal-body">
	 <div class="tabbable">
	    <?php echo $this->Form->create("DatosUsuario") ?>
        <div class="tab-content">
                               
				<?php echo $this->element("usuarios/datos_usuario_form") ?>
