...
<div class="well">
	...
	<div>
		<?php echo $this->Js->link("<i class='icon-search icon-white'> Buscar</i>",array('controller'=>'usuarios','action'=>'buscar'),array('update'=>'#resultado_busqueda','before'=>'inicia_ajax()','complete'=>'fin_ajax()','escape'=>false,"data"=>"$(this).parents('form:first').serialize()","class"=>"btn btn-inverse","dataExpression"=>true,"method"=>"post")); 
