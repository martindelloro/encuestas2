...
<div class="modal-body">
    ...
    <div style="text-align: center">
     <?php 
     echo $this->Form->Button("<i class='icon-plus'>Continuar con la carga de usuarios</i>",array("class"=>"btn","id"=>"boton_continuar"));
     ...
     //echo $this->Js->link("<i class='icon-plus'>Continuar con la carga de usuarios</i>",array("controller"=>"my_files","action"=>""),array("class"=>"btn btn-inverse","before"=>"modales('crearPregunta','modal-ficha')","complete"=>"fin_ajax('crearPregunta')","update"=>"#crearPregunta","escape"=>false)); ?>
        ...
        <?php echo $this->Html->link("<i class='icon-white icon-remove-sign'>Cancelar</i>","#",array("class"=>"btn btn-inverse","data-dismiss"=>"modal","escape"=>false)) ?>
    </div>
